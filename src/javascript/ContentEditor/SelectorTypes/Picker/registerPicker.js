...
export const registerPicker = registry => {
    ...
    registry.add('selectorType', 'Picker', {
        ...
        labelKey: 'jcontent:label.contentEditor.selectorTypes.picker.displayValue',
        properties: [
            {name: 'description', value: 'jcontent:label.contentEditor.selectorTypes.picker.description'},
