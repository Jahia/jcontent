...
export const CopyFromSourceLanguageIcon = ({size, className, color, ...otherProps}) => {
    const classNameColor = color ? ' moonstone-icon_' + color : '';
    const props = {
        ...otherProps,
        className: (className || '') + ' moonstone-icon moonstone-icon_' + size + classNameColor
    };
...
CopyFromSourceLanguageIcon.propTypes = {
    size: PropTypes.string,
    className: PropTypes.string,
    color: PropTypes.string
};

CopyFromSourceLanguageIcon.defaultProps = {
    size: 'default'
};
