...
const actionTargetAssignments = {
    ...
    headerPrimaryActions: ['createPage', 'createContentFolder', 'createFolder', 'createContent', 'edit', 'editPage', 'fileUpload', 'paste', 'pasteReference', 'clearClipboard', 'refresh', 'separator'],
    ...
    browseControlBar: ['rename', 'editAdvanced', 'editPageAdvanced', 'editImage', 'replaceFile', 'downloadFile', 'downloadAsZip', 'import', 'exportPage', 'export', 'delete', 'deletePermanently', 'undelete', 'clearAllLocks', 'flushPageCache', 'flushSiteCache', 'openInRepositoryExplorer', 'contentActionsSeparator3'],
    ...
    visibleContentItemActions: ['preview', 'edit', 'editPage', 'subContents'],
