...
export class UploadItem extends React.Component {
    ...
    render() {
        ...
        const fileName = this.state.userChosenName ? this.state.userChosenName : (file ? file.name : entry.name);
            ...
            <div className={styles.listItem}>
                ...
                <Dialog open={this.state.anchorEl !== null}>
                    ...
                    <DialogActions>
                        ...
                        <Button
                            label={t('jcontent:label.contentManager.fileUpload.dialogRename')}
                            size="big"
                            color="accent"
                            isDisabled={Boolean(errMsg)}
                            data-cm-role="upload-rename-button"
                            onClick={() => this.setState({anchorEl: null}, () => this.changeStatusToUploading())}
                        />
                    </DialogActions>
                </Dialog>
            </div>
