...
describe('ContentStatuses', () => {
    ...
    it('should a \'Usages\' status', () => {
        ...
        const wrapper = shallow(<ContentStatuses {...defaultProps} renderedStatuses={['usagesCount']} node={node}/>);

        expect(wrapper.containsMatchingElement(<Status type="usagesCount"/>)).toBeTruthy();
    });
});
