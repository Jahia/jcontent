...
const DeleteQueries = gql`
    ...
    jcr {
        nodesByPath(paths: $paths) {
            ...
            allDescendants : descendants(typesFilter:{types:["jnt:content", "jnt:page", "jnt:folder", "jnt:file"], multi:ANY}, limit: 100) @include(if: $getUsages) {
                pageInfo {
                    totalCount
                }
                nodes {
            ...
            isFolder: isNodeType(type:{types: ["jnt:folder"], multi: ALL})
