...
class FileUploadAction extends React.Component {
    ...
    //         childNodeTypes = FileUploadAction.filterByBaseType(childNodeTypes, baseContentType);
    //     }
    ...
    //                     contributionNodeTypes = FileUploadAction.filterByBaseType(contributionNodeTypes, baseContentType);
