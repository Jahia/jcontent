...
import {composeActions, ProgressOverlay, withNotifications} from "@jahia/react-material";
...
export default composeActions(requirementsAction, withNodeName, {
    ...
    onClick:(context) => window.parent.authoringApi.openPublicationWorkflow(context.uuid, context.allSubTree, context.allLanguages, context.checkForUnpublication)
});